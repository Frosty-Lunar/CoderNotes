...
&lt;html&gt;
  ...
  &lt;/body&gt;
&lt;/html&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="项目重启免登录" tabindex="-1"><a class="header-anchor" href="#项目重启免登录" aria-hidden="true">#</a> 项目重启免登录</h2><p>实现重启免登录的关键要素是对于Session的序列化</p><h3 id="相关概念" tabindex="-1"><a class="header-anchor" href="#相关概念" aria-hidden="true">#</a> 相关概念</h3><p>首先明白这几个概念:</p><ul><li>序列化与反序列 <ul><li>把对象转化为字节序列的过程称为序列化（保存到硬盘，持久化）</li><li>把字节序列转化为对象的过程称为反序列化（存放于内存）</li></ul></li><li>序列化的用途 <ul><li>把对象的字节序列永久保存到硬盘上，通常放到一个文件中。</li><li>把网络传输的对象通过字节序列化，方便传输</li></ul></li></ul><h3 id="实现步骤" tabindex="-1"><a class="header-anchor" href="#实现步骤" aria-hidden="true">#</a> 实现步骤</h3><h4 id="准备工作" tabindex="-1"><a class="header-anchor" href="#准备工作" aria-hidden="true">#</a> 准备工作</h4><p>在META-INF下创建<code>Context.xml</code></p><div class="language-XML line-numbers-mode" data-ext="XML"><pre class="language-XML"><code>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;
  &lt;Context&gt;
