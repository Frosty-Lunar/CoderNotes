import{_ as r}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as c,c as u,d as a,b as n,w as d,e,f as s}from"./app-5f4e7946.js";const v="/CoderNotes/assets/Pasted_image_20230412104903-c1ee527f.png",p="/CoderNotes/assets/Pasted_image_20230412104915-d0fa74e6.png",o="/CoderNotes/assets/Pasted_image_20230412104926-ef2ec7cf.png",m="/CoderNotes/assets/Pasted_image_20230412105124-aa0ff3d3.png",b={},h=a("p",null,"在前面的学习中,我们简单搭建了一个Mybatis的项目环境",-1),g=s('<p>基于普通模式的开发,也成为传统DAO模式. 简单来讲就是创建对应的接口,然后在接口的实现类中使用SQLSession对象调用select insert delete update 等方法实现. 目前我们能开发中不再使用这种方式,但是我们仍需要了解SQLSession的基本API实现CRUD的功能以及参数的传递</p><h2 id="构建环境" tabindex="-1"><a class="header-anchor" href="#构建环境" aria-hidden="true">#</a> 构建环境</h2><p>本次我们尝试对Emp表进行操作,所以需要执行以下操作:</p><h4 id="新增emp实体类" tabindex="-1"><a class="header-anchor" href="#新增emp实体类" aria-hidden="true">#</a> 新增Emp实体类</h4><figure><img src="'+v+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="新增empmapper-xml" tabindex="-1"><a class="header-anchor" href="#新增empmapper-xml" aria-hidden="true">#</a> 新增EmpMapper.xml</h4><figure><img src="'+p+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="新增xml文件映射" tabindex="-1"><a class="header-anchor" href="#新增xml文件映射" aria-hidden="true">#</a> 新增XML文件映射</h4><p>由于当前使用的是非接口式开发,所以Mappers标签中不可以使用Package标签进行扫描,只能一个一个mapper标签的对XML进行注册</p><figure><img src="'+o+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="新增测试类" tabindex="-1"><a class="header-anchor" href="#新增测试类" aria-hidden="true">#</a> 新增测试类</h4><figure><img src="'+m+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="sqlsession-查询的三种方式" tabindex="-1"><a class="header-anchor" href="#sqlsession-查询的三种方式" aria-hidden="true">#</a> SQLSession 查询的三种方式</h2><p>SQLSession对象本身的API中存在三个查询方法,能够实现如下查询方式:</p><ol><li>返回单个对象 : <code>selectOne</code></li><li>返回对象的List集合 : <code>selectList</code></li><li>返回对象的Map集合 : <code>selectMap</code></li></ol><h3 id="返回单个对象" tabindex="-1"><a class="header-anchor" href="#返回单个对象" aria-hidden="true">#</a> 返回单个对象</h3><h4 id="mapper层" tabindex="-1"><a class="header-anchor" href="#mapper层" aria-hidden="true">#</a> Mapper层</h4><p>正常情况下我们查询单个对象的Java代码如下</p><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public emp findOne(){
   ......
}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,52);function A(B,T){const l=i("RouterLink"),t=i("font");return c(),u("div",null,[h,a("p",null,[n(l,{to:"/doc/02_%E5%88%9D%E7%BA%A7%E5%BC%80%E5%8F%91%E5%B7%A5%E7%A8%8B%E5%B8%88/01_%E7%AC%AC%E4%B8%80%E9%98%B6%E6%AE%B5/05_%E5%9F%BA%E7%A1%80%E6%A1%86%E6%9E%B6/01_Mybatis%E5%9F%BA%E7%A1%80/02_%E6%90%AD%E5%BB%BAMybatis%E9%A1%B9%E7%9B%AE%E7%8E%AF%E5%A2%83/%E6%90%AD%E5%BB%BAMybatis%E9%A1%B9%E7%9B%AE%E7%8E%AF%E5%A2%83.html#%E5%9F%BA%E7%A1%80%E5%86%99%E6%B3%95%E6%80%9D%E8%B7%AF"},{default:d(()=>[e("基础写法思路")]),_:1})]),g,a("p",null,[e("使用"),E,e(" 或 "),f,e(" 来进行参数的占位,两者区别如下:"),q,e("  - "),M,e(" 代表mybatis底层使用"),x,e("语句对象,参数是以字符串拼接的形式设置"),J,e("  - "),_,e(" 代表mybatis底层使用的"),S,e("语句对象,参数使用?作为占位符处理"),n(t,{color:"#ff0000"},{default:d(()=>[e("[常用]")]),_:1})]),y])}const O=r(b,[["render",A],["__file","MyBatis普通模式的开发.html.vue"]]);export{O as default};
